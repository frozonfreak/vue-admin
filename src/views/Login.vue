<template>
  <el-form :model="ruleForm2" :rules="rules2" ref="ruleForm2" label-position="left" label-width="0px" class="demo-ruleForm login-container">
    ...
    <el-form-item style="width:100%;">
      <el-button type="primary" style="width:100%;" @click.native.prevent="handleSubmit2" :loading="loading">Login</el-button>
      <el-button style="width:100%;" @click.native.prevent="handleReset2">Reset</el-button>
    </el-form-item>
  </el-form>
</template>
